...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button regisgterButton = (Button) findViewById(R.id.button_register);
        ...
        Button recognitionButton = (Button) findViewById(R.id.button_recognition);
        ...
        Button recognitionButton2 = (Button) findViewById(R.id.button_recognition_more);
